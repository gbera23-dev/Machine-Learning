...
ამ სურვილმა გაამართლა, 
ConvNeXt — თანამედროვე, transformer-ისგან შთაგონებული convolutional არქიტექტურა — გახდა ამ პროექტში საბოლოოდ შერჩეული მოდელი.
...
თუმცა გაცილებით მცირე მასშტაბის, ვიდრე Deep Baseline CNN-ში (25.39), Deep BatchNorm CNN-ში (21.89) 
ან, რა თქმა უნდა, არარეგულარიზებულ ResNet-ში (46.43). ის უფრო დიდია, ვიდრე რეგულარიზებულ ResNet-ში (2.42), 
მაგრამ ამავდროულად ConvNeXt-ი აღწევს ყველაზე მაღალ ვალიდაციის სიზუსტეს ყველა მოდელს შორის.
...
**ConvNeXt** შეირჩა საბოლოო მოდელად — მან მიაღწია ყველაზე მაღალ ვალიდაციის სიზუსტეს (64.53%) ყველა მოდელს შორის, 
თუმცა ვარიაციის შედარებით მაღალი დონით ვიდრე რეგულირიზებულ რეზნეტში(9% სხვაობა),
რაც გაცილებით უკეთესად კონტროლირებადია, ვიდრე Deep Baseline/BatchNorm CNN-ებში ან არარეგულარიზებულ ResNet-ში, 
თუმცა ნაკლებად გენერალიზებადი ვიდრე რეგულარიზებული ResNet. 
